      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <Card className="max-w-4xl mx-auto border-2 border-primary/20 shadow-xl">
          ...
          <CardContent className="space-y-4 text-muted-foreground">
            ...
            <h3 className="font-headline text-xl font-semibold text-foreground pt-4">1. Acceptance of Terms</h3>
            <p>By accessing or using the Service, you agree to be bound by these Terms. If you disagree with any part of the terms, then you may not access the Service.</p>

            <h3 className="font-headline text-xl font-semibold text-foreground pt-4">2. Donations</h3>
            ...
            <h3 className="font-headline text-xl font-semibold text-foreground pt-4">3. Intellectual Property</h3>
            ...
            <h3 className="font-headline text-xl font-semibold text-foreground pt-4">4. Links To Other Web Sites</h3>
            ...
            <h3 className="font-headline text-xl font-semibold text-foreground pt-4">5. Governing Law</h3>
            <p>These Terms shall be governed and construed in accordance with the laws of India, without regard to its conflict of law provisions.</p>
            
            <h3 className="font-headline text-xl font-semibold text-foreground pt-4">6. Changes</h3>
            ...
            <h3 className="font-headline text-xl font-semibold text-foreground pt-4">7. Contact Us</h3>
