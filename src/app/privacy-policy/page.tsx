      ...
      <div className="container mx-auto px-4 py-8 sm:py-12">
        ...
        <Card className="max-w-4xl mx-auto border-2 border-primary/20 shadow-xl">
          ...
          <CardContent className="space-y-4 text-muted-foreground">
            ...
            <h3 className="font-headline text-lg sm:text-xl font-semibold text-foreground pt-4">1. Information We Collect</h3>
            ...
            <h3 className="font-headline text-lg sm:text-xl font-semibold text-foreground pt-4">2. Use of Your Information</h3>
            ...
            <h3 className="font-headline text-lg sm:text-xl font-semibold text-foreground pt-4">3. Disclosure of Your Information</h3>
            ...
            <h3 className="font-headline text-lg sm:text-xl font-semibold text-foreground pt-4">4. Security of Your Information</h3>
            <p>We use administrative, technical, and physical security measures to help protect your personal information. While we have taken reasonable steps to secure the personal information you provide to us, please be aware that despite our efforts, no security measures are perfect or impenetrable.</p>

            <h3 className="font-headline text-lg sm:text-xl font-semibold text-foreground pt-4">5. Contact Us</h3>
